...
Production is deployed with the `run-on-server`/`rasppost` workflow to `cos.ssh.codes`. Mutable submissions live in `DATA_DIR`, outside the deployed app directory.
